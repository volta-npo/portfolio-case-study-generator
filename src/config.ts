  ...
  "criteria": [
    {
      ...
      "prompt": "Implement and verify case study outline with evidence that a Volta student pod, mentor, and owner can understand."
    },
    {
      "id": "consent-and-privacy-prompts",
      "label": "Consent and privacy prompts",
      "weight": 15,
      "defaultStatus": "not-started",
      "prompt": "Implement and verify consent and privacy prompts with evidence that a Volta student pod, mentor, and owner can understand."
    },
    {
      ...
      "weight": 15,
      "defaultStatus": "not-started",
      "prompt": "Implement and verify before/after proof fields with evidence that a Volta student pod, mentor, and owner can understand."
    },
    {
      ...
      "weight": 15,
      "defaultStatus": "not-started",
      "prompt": "Implement and verify reflection questions with evidence that a Volta student pod, mentor, and owner can understand."
    },
    {
      "id": "evidence-quality",
